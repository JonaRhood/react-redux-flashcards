const quizzes = {
    ...
    'society and culture quiz': {
        ...
        topicId: 'example 2',
        cardIds: ['society5', 'society6', 'society7', 'society8'],
        icon: 'https://static-assets.codecademy.com/skillpaths/react-redux/redux-quiz-app/statistics.svg',
        topicName: 'Society'
    },
    ...
    'fantasy creatures quiz': {
        ...
        name: 'Fantasy Creatures Quiz',
        topicId: 'example 2',
        cardIds: ['fantasy9', 'fantasy10', 'fantasy11', 'fantasy12'],
        icon: 'https://static-assets.codecademy.com/skillpaths/react-redux/redux-quiz-app/spade.svg',
        topicName: 'Fantasy'
    },
    ...
    'fantasy realms quiz': {
        ...
        name: 'Fantasy Realms Quiz',
        topicId: 'example 2',
        cardIds: ['fantasy13', 'fantasy14', 'fantasy15', 'fantasy16'],
        icon: 'https://static-assets.codecademy.com/skillpaths/react-redux/redux-quiz-app/spade.svg',
        topicName: 'Fantasy'
    },
    'wildlife quiz': {
